    ...
    var filterProducts = function () {
        ...
        $('input[name="availability"]').on("change", function () {
            filters.availability =
                $(this).attr("id") === "inStock" ? "Còn hàng" : "Hết hàng";
            applyFilters();
            updateMetaFilter();
        });
        ...
        function updateMetaFilter() {
            ...
            if (filters.availability) {
                appliedFilters.append(
                    `<span class="filter-tag"><span class="remove-tag icon-close" data-filter="availability"></span> Tình trạng: ${filters.availability} </span>`
                );
            }
            if (filters.brands) {
                appliedFilters.append(
                    `<span class="filter-tag"><span class="remove-tag icon-close" data-filter="brand"></span>Thương hiệu: ${filters.brands}</span>`
                );
            }
            if (filters.minPrice > minPrice || filters.maxPrice < maxPrice) {
                appliedFilters.append(
                    `<span class="filter-tag"><span class="remove-tag icon-close" data-filter="price"></span>Giá: $${filters.minPrice} - $${filters.maxPrice}</span>`
                );
            }
            if (filters.color) {
                appliedFilters.append(
        ...
        function applyFilters() {
            ...
            $("#product-count-grid").html(
                `<span class="count">${visibleProductCountGrid}</span>Sản phẩm tìm thấy`
            );
            $("#product-count-list").html(
                `<span class="count">${visibleProductCountList}</span>Sản phẩm tìm thấy`
            );
            ...
            if (
                ...
                $(
                    ".wrapper-shop .wg-pagination,.wrapper-shop .tf-loading"
                ).show();
            } else {
                $(
                    ".wrapper-shop .wg-pagination,.wrapper-shop .tf-loading"
