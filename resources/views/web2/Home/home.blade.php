                        ...
                        <div class="product-overlay">
                            <div class="icon-box cart-icon">
                                <form action="{{ route('cart.create', ['id' => $bestSeller->id]) }}" method="post">
                                    ...
                                    <input type="hidden" name="price" value="{{ $bestSeller->variants->min('price') }}">
            ...
            <div class="col-md-6 d-flex flex-column align-items-center">
                <a href="{{ route('web.shopByCate', 2) }}" class="view-details mt-2">
                    <div class="w-100">
                        ...
                        <div class="text-center mt-2">
                            <p class="font-black tracking-wide text-black">
                                Với bộ sưu tập nước hoa mới, ARMAF khéo léo nắm bắt mọi khía cạnh trong khuôn dung và
                                nội
                                hàm
            ...
            <form action="">
                <div class="input-group">
                    ...
                    <div class="input-group-append">
                        <button class="btn btn-primary px-4 rounded-right" style="border-radius: 0 25px 25px 0;">Đăng
                            ký</button>
                    </div>
                </div>
            </form>
...
<body>
    <div class="container py-5">
        <div class="text-center mb-5">
            <h3 class="text-3xl font-black tracking-wide text-black uppercase flex items-center justify-center gap-2">
