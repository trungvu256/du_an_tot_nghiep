                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="hstack gap-3 flex-wrap">
                                    ...
                                    <div class="text-muted">Thể loại : <span
                                            class="text-body fw-medium">{{ $product->category->name }}</span></div>
                                    <div class="vr"></div>
                                        ...
                                        @foreach ($variants as $variant)
                                            <div data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top"
                                                ...
                                                <label
                                                    ...
                                                    for="productsize-radio1">{{ $variant->name }}</label>
                                            </div>
                                        @endforeach
                                    </div>
                                </div>
                                ...
                                <ul class="nav nav-tabs nav-tabs-custom nav-success" id="nav-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="nav-speci-tab" data-bs-toggle="tab" href="#nav-speci"
                                            role="tab" aria-controls="nav-speci" aria-selected="true">Specification</a>
                                    </li>
                                    <li class="nav-item">
