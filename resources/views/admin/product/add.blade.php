                ...
                <div class="row mb-3">
                        ...
                        <select name="catalogue_id" class="form-select">
                            ...
                            @foreach ($catalogues as $catalogue)
                                <option value="{{ $catalogue->id }}"
                                    {{ old('catalogue_id') == $catalogue->id ? 'selected' : '' }}>{{ $catalogue->name }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="fragrance_group" class="form-select">
                            ...
                            <option value="Floral" {{ old('fragrance_group') == 'Floral' ? 'selected' : '' }}>Floral (Hương hoa)</option>
                            <option value="Woody" {{ old('fragrance_group') == 'Woody' ? 'selected' : '' }}>Woody (Hương gỗ)</option>
                            <option value="Citrus" {{ old('fragrance_group') == 'Citrus' ? 'selected' : '' }}>Citrus (Hương cam chanh)</option>
                            <option value="Oriental" {{ old('fragrance_group') == 'Oriental' ? 'selected' : '' }}>Oriental (Hương phương Đông)</option>
                            <option value="Fresh" {{ old('fragrance_group') == 'Fresh' ? 'selected' : '' }}>Fresh (Hương tươi mát)</option>
                            <option value="Fougere" {{ old('fragrance_group') == 'Fougere' ? 'selected' : '' }}>Fougere (Hương dương xỉ)</option>
                            <option value="Chypre" {{ old('fragrance_group') == 'Chypre' ? 'selected' : '' }}>Chypre (Hương Chypre)</option>
                        </select>
                    ...
                    document.addEventListener("DOMContentLoaded", function() {
                        ...
                        document.getElementById("add-variant").addEventListener("click", function() {
                            ...
                            let newVariant = {
                                ...
                                special_edition: specialEdition ? specialEdition : null, // Đảm bảo không bị null
