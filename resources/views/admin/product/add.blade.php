            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <select name="fragrance_group" class="form-select">
                        ...
                        <option value="Floral" {{ old('fragrance_group') == 'Floral' ? 'selected' : '' }}>Floral (Hương
                            hoa)</option>
                        <option value="Woody" {{ old('fragrance_group') == 'Woody' ? 'selected' : '' }}>Woody (Hương gỗ)
                        </option>
                        <option value="Citrus" {{ old('fragrance_group') == 'Citrus' ? 'selected' : '' }}>Citrus (Hương cam
                            chanh)</option>
                        <option value="Oriental" {{ old('fragrance_group') == 'Oriental' ? 'selected' : '' }}>Oriental
                            (Hương phương Đông)</option>
                        <option value="Fresh" {{ old('fragrance_group') == 'Fresh' ? 'selected' : '' }}>Fresh (Hương tươi
                            mát)</option>
                        <option value="Fougere" {{ old('fragrance_group') == 'Fougere' ? 'selected' : '' }}>Fougere (Hương
                            dương xỉ)</option>
                        <option value="Chypre" {{ old('fragrance_group') == 'Chypre' ? 'selected' : '' }}>Chypre (Hương
                            Chypre)</option>
                    </select>
