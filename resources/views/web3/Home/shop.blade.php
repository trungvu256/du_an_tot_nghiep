            ...
            function updateAppliedFilters() {
                ...
                if (data['brand[]']) {
                    data['brand[]'].forEach(brand => {
                        ...
                        filterHtml +=
                            `<span class="filter-tag">${brandName}<span class="remove-filter" data-type="brand[]" data-value="${brand}">×</span></span>`;
                    });
                }
                ...
                if (data['price_range[]']) {
                    data['price_range[]'].forEach(range => {
                        ...
                        filterHtml +=
                            `<span class="filter-tag">${priceLabel}<span class="remove-filter" data-type="price_range[]" data-value="${range}">×</span></span>`;
                    });
                }
            ...
            function fetchFilteredProducts(url = null) {
                ...
                $.ajax({
                    ...
                    beforeSend: function() {
                        ...
                        $('#gridLayout').addClass('loading-overlay').html(
